...
export class AccountServiceProxy {
    ...
    protected processResolveTenantId(response: Response): Promise<number> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processResetPassword(response: Response): Promise<ResetPasswordOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processSendEmailActivationLink(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processActivateEmail(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    impersonateUser(body: ImpersonateUserInput | undefined): Promise<ImpersonateOutput> {
    ...
    protected processImpersonateUser(response: Response): Promise<ImpersonateOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    impersonateTenant(body: ImpersonateTenantInput | undefined): Promise<ImpersonateOutput> {
    ...
    protected processImpersonateTenant(response: Response): Promise<ImpersonateOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    delegatedImpersonate(body: DelegatedImpersonateInput | undefined): Promise<ImpersonateOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDelegatedImpersonate(_response);
        });
    }

    protected processDelegatedImpersonate(response: Response): Promise<ImpersonateOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processBackToImpersonator(response: Response): Promise<ImpersonateOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processSwitchToLinkedAccount(response: Response): Promise<SwitchToLinkedAccountOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class AuditLogServiceProxy {
    ...
    protected processGetAuditLogs(response: Response): Promise<PagedResultDtoOfAuditLogListDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetAuditLogsToExcel(response: Response): Promise<FileDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetEntityHistoryObjectTypes(response: Response): Promise<NameValueDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetEntityChanges(response: Response): Promise<PagedResultDtoOfEntityChangeListDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getEntityTypeChanges(entityTypeFullName: string | undefined, entityId: string | undefined, sorting: string | undefined, maxResultCount: number | undefined, skipCount: number | undefined): Promise<PagedResultDtoOfEntityChangeListDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetEntityTypeChanges(_response);
        });
    }

    protected processGetEntityTypeChanges(response: Response): Promise<PagedResultDtoOfEntityChangeListDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetEntityChangesToExcel(response: Response): Promise<FileDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    getEntityPropertyChanges(entityChangeId: number | undefined): Promise<EntityPropertyChangeDto[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetEntityPropertyChanges(_response);
        });
    }

    protected processGetEntityPropertyChanges(response: Response): Promise<EntityPropertyChangeDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<EntityPropertyChangeDto[]>(null as any);
    }
}
...
export class CachingServiceProxy {
     ...
     * @return Success
     */
    getAllCaches(): Promise<ListResultDtoOfCacheDto> {
    ...
    protected processGetAllCaches(response: Response): Promise<ListResultDtoOfCacheDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListResultDtoOfCacheDto>(null as any);
    }
    ...
    protected processClearAllCaches(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class ChatServiceProxy {
    ...
    protected processGetUserChatFriendsWithSettings(response: Response): Promise<GetUserChatFriendsWithSettingsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetUserChatFriendsWithSettingsOutput>(null as any);
    }
    ...
    protected processGetUserChatMessages(response: Response): Promise<ListResultDtoOfChatMessageDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListResultDtoOfChatMessageDto>(null as any);
    }
    ...
    protected processMarkAllUnreadMessagesOfUserAsRead(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class CommonLookupServiceProxy {
    ...
    protected processGetEditionsForCombobox(response: Response): Promise<ListResultDtoOfSubscribableEditionComboboxItemDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processFindUsers(response: Response): Promise<PagedResultDtoOfNameValueDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetDefaultEditionName(response: Response): Promise<GetDefaultEditionNameOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class DashboardCustomizationServiceProxy {
     ...
     * @return Success
     */
    getUserDashboard(dashboardName: string | undefined, application: string | undefined): Promise<Dashboard> {
    ...
    protected processGetUserDashboard(response: Response): Promise<Dashboard> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    savePage(body: SavePageInput | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSavePage(_response);
        });
    }

    protected processSavePage(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    renamePage(body: RenamePageInput | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processRenamePage(_response);
        });
    }

    protected processRenamePage(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    addNewPage(body: AddNewPageInput | undefined): Promise<AddNewPageOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processAddNewPage(_response);
        });
    }

    protected processAddNewPage(response: Response): Promise<AddNewPageOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<AddNewPageOutput>(null as any);
    }
     ...
     * @return Success
     */
    deletePage(id: string | undefined, dashboardName: string | undefined, application: string | undefined): Promise<void> {
    ...
    protected processDeletePage(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    addWidget(body: AddWidgetInput | undefined): Promise<Widget> {
    ...
    protected processAddWidget(response: Response): Promise<Widget> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getDashboardDefinition(dashboardName: string | undefined, application: string | undefined): Promise<DashboardOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetDashboardDefinition(_response);
        });
    }

    protected processGetDashboardDefinition(response: Response): Promise<DashboardOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<DashboardOutput>(null as any);
    }
     ...
     * @return Success
     */
    getAllWidgetDefinitions(dashboardName: string | undefined, application: string | undefined): Promise<WidgetOutput[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAllWidgetDefinitions(_response);
        });
    }

    protected processGetAllWidgetDefinitions(response: Response): Promise<WidgetOutput[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<WidgetOutput[]>(null as any);
    }
     ...
     * @return Success
     */
    getAllAvailableWidgetDefinitionsForPage(dashboardName: string | undefined, application: string | undefined, pageId: string | undefined): Promise<WidgetOutput[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAllAvailableWidgetDefinitionsForPage(_response);
        });
    }

    protected processGetAllAvailableWidgetDefinitionsForPage(response: Response): Promise<WidgetOutput[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getSettingName(application: string | undefined): Promise<string> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetSettingName(_response);
        });
    }

    protected processGetSettingName(response: Response): Promise<string> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class DemoUiComponentsServiceProxy {
    ...
    sendAndGetDate(date: DateTime | undefined): Promise<DateToStringOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSendAndGetDate(_response);
        });
    }

    protected processSendAndGetDate(response: Response): Promise<DateToStringOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<DateToStringOutput>(null as any);
    }
    ...
    sendAndGetDateTime(date: DateTime | undefined): Promise<DateToStringOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSendAndGetDateTime(_response);
        });
    }

    protected processSendAndGetDateTime(response: Response): Promise<DateToStringOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    sendAndGetDateRange(startDate: DateTime | undefined, endDate: DateTime | undefined): Promise<DateToStringOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSendAndGetDateRange(_response);
        });
    }

    protected processSendAndGetDateRange(response: Response): Promise<DateToStringOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getCountries(searchTerm: string | undefined): Promise<NameValueOfString[]> {
    ...
    protected processGetCountries(response: Response): Promise<NameValueOfString[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<NameValueOfString[]>(null as any);
    }
     ...
     * @return Success
     */
    sendAndGetSelectedCountries(body: NameValueOfString[] | undefined): Promise<NameValueOfString[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSendAndGetSelectedCountries(_response);
        });
    }

    protected processSendAndGetSelectedCountries(response: Response): Promise<NameValueOfString[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    sendAndGetValue(input: string | undefined): Promise<StringOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSendAndGetValue(_response);
        });
    }

    protected processSendAndGetValue(response: Response): Promise<StringOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<StringOutput>(null as any);
    }
}
...
export class DynamicEntityPropertyServiceProxy {
     ...
     * @return Success
     */
    get(id: number | undefined): Promise<DynamicEntityPropertyDto> {
    ...
    protected processGet(response: Response): Promise<DynamicEntityPropertyDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<DynamicEntityPropertyDto>(null as any);
    }
     ...
     * @return Success
     */
    getAllPropertiesOfAnEntity(entityFullName: string | undefined): Promise<ListResultDtoOfDynamicEntityPropertyDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAllPropertiesOfAnEntity(_response);
        });
    }

    protected processGetAllPropertiesOfAnEntity(response: Response): Promise<ListResultDtoOfDynamicEntityPropertyDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListResultDtoOfDynamicEntityPropertyDto>(null as any);
    }

    /**
     * @return Success
     */
    getAll(): Promise<ListResultDtoOfDynamicEntityPropertyDto> {
    ...
    protected processGetAll(response: Response): Promise<ListResultDtoOfDynamicEntityPropertyDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    add(body: DynamicEntityPropertyDto | undefined): Promise<void> {
     ...
     * @return Success
     */
    update(body: DynamicEntityPropertyDto | undefined): Promise<void> {
     ...
     * @return Success
     */
    getAllEntitiesHasDynamicProperty(): Promise<ListResultDtoOfGetAllEntitiesHasDynamicPropertyOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAllEntitiesHasDynamicProperty(_response);
        });
    }

    protected processGetAllEntitiesHasDynamicProperty(response: Response): Promise<ListResultDtoOfGetAllEntitiesHasDynamicPropertyOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListResultDtoOfGetAllEntitiesHasDynamicPropertyOutput>(null as any);
    }
}
...
export class DynamicEntityPropertyDefinitionServiceProxy {
     ...
     * @return Success
     */
    getAllAllowedInputTypeNames(): Promise<string[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAllAllowedInputTypeNames(_response);
        });
    }

    protected processGetAllAllowedInputTypeNames(response: Response): Promise<string[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    getAllEntities(): Promise<string[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAllEntities(_response);
        });
    }

    protected processGetAllEntities(response: Response): Promise<string[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class DynamicEntityPropertyValueServiceProxy {
     ...
     * @return Success
     */
    get(id: number | undefined): Promise<DynamicEntityPropertyValueDto> {
    ...
    protected processGet(response: Response): Promise<DynamicEntityPropertyValueDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<DynamicEntityPropertyValueDto>(null as any);
    }
     ...
     * @return Success
     */
    getAll(entityId: string | undefined, propertyId: number | undefined): Promise<ListResultDtoOfDynamicEntityPropertyValueDto> {
    ...
    protected processGetAll(response: Response): Promise<ListResultDtoOfDynamicEntityPropertyValueDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListResultDtoOfDynamicEntityPropertyValueDto>(null as any);
    }
     ...
     * @return Success
     */
    add(body: DynamicEntityPropertyValueDto | undefined): Promise<void> {
     ...
     * @return Success
     */
    update(body: DynamicEntityPropertyValueDto | undefined): Promise<void> {
     ...
     * @return Success
     */
    getAllDynamicEntityPropertyValues(entityFullName: string, entityId: string): Promise<GetAllDynamicEntityPropertyValuesOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAllDynamicEntityPropertyValues(_response);
        });
    }

    protected processGetAllDynamicEntityPropertyValues(response: Response): Promise<GetAllDynamicEntityPropertyValuesOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetAllDynamicEntityPropertyValuesOutput>(null as any);
    }
     ...
     * @return Success
     */
    insertOrUpdateAllValues(body: InsertOrUpdateAllValuesInput | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processInsertOrUpdateAllValues(_response);
        });
    }

    protected processInsertOrUpdateAllValues(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    cleanValues(body: CleanValuesInput | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCleanValues(_response);
        });
    }

    protected processCleanValues(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class DynamicPropertyServiceProxy {
     ...
     * @return Success
     */
    get(id: number | undefined): Promise<DynamicPropertyDto> {
    ...
    protected processGet(response: Response): Promise<DynamicPropertyDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<DynamicPropertyDto>(null as any);
    }

    /**
     * @return Success
     */
    getAll(): Promise<ListResultDtoOfDynamicPropertyDto> {
    ...
    protected processGetAll(response: Response): Promise<ListResultDtoOfDynamicPropertyDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListResultDtoOfDynamicPropertyDto>(null as any);
    }
     ...
     * @return Success
     */
    add(body: DynamicPropertyDto | undefined): Promise<void> {
     ...
     * @return Success
     */
    update(body: DynamicPropertyDto | undefined): Promise<void> {
     ...
     * @return Success
     */
    findAllowedInputType(name: string | undefined): Promise<IInputType> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processFindAllowedInputType(_response);
        });
    }

    protected processFindAllowedInputType(response: Response): Promise<IInputType> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<IInputType>(null as any);
    }
}
...
export class DynamicPropertyValueServiceProxy {
     ...
     * @return Success
     */
    get(id: number | undefined): Promise<DynamicPropertyValueDto> {
    ...
    protected processGet(response: Response): Promise<DynamicPropertyValueDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<DynamicPropertyValueDto>(null as any);
    }
     ...
     * @return Success
     */
    getAllValuesOfDynamicProperty(id: number | undefined): Promise<ListResultDtoOfDynamicPropertyValueDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAllValuesOfDynamicProperty(_response);
        });
    }

    protected processGetAllValuesOfDynamicProperty(response: Response): Promise<ListResultDtoOfDynamicPropertyValueDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListResultDtoOfDynamicPropertyValueDto>(null as any);
    }
     ...
     * @return Success
     */
    add(body: DynamicPropertyValueDto | undefined): Promise<void> {
     ...
     * @return Success
     */
    update(body: DynamicPropertyValueDto | undefined): Promise<void> {
...
export class EditionServiceProxy {
    ...
    protected processGetEditions(response: Response): Promise<ListResultDtoOfEditionListDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetEditionForEdit(response: Response): Promise<GetEditionEditOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    createEdition(body: CreateEditionDto | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCreateEdition(_response);
        });
    }

    protected processCreateEdition(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    updateEdition(body: UpdateEditionDto | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUpdateEdition(_response);
        });
    }

    protected processUpdateEdition(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processDeleteEdition(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processMoveTenantsToAnotherEdition(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetEditionComboboxItems(response: Response): Promise<SubscribableEditionComboboxItemDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetTenantCount(response: Response): Promise<number> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class FriendshipServiceProxy {
    ...
    protected processCreateFriendshipRequest(response: Response): Promise<FriendDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processCreateFriendshipRequestByUserName(response: Response): Promise<FriendDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processUnblockUser(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processAcceptFriendshipRequest(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class HostDashboardServiceProxy {
    ...
    getTopStatsData(startDate: DateTime | undefined, endDate: DateTime | undefined): Promise<TopStatsData> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetTopStatsData(_response);
        });
    }

    protected processGetTopStatsData(response: Response): Promise<TopStatsData> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<TopStatsData>(null as any);
    }

    /**
     * @return Success
     */
    getRecentTenantsData(): Promise<GetRecentTenantsOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetRecentTenantsData(_response);
        });
    }

    protected processGetRecentTenantsData(response: Response): Promise<GetRecentTenantsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetRecentTenantsOutput>(null as any);
    }

    /**
     * @return Success
     */
    getSubscriptionExpiringTenantsData(): Promise<GetExpiringTenantsOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetSubscriptionExpiringTenantsData(_response);
        });
    }

    protected processGetSubscriptionExpiringTenantsData(response: Response): Promise<GetExpiringTenantsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetExpiringTenantsOutput>(null as any);
    }
    ...
    getIncomeStatistics(incomeStatisticsDateInterval: ChartDateInterval, startDate: DateTime | undefined, endDate: DateTime | undefined): Promise<GetIncomeStatisticsDataOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetIncomeStatistics(_response);
        });
    }

    protected processGetIncomeStatistics(response: Response): Promise<GetIncomeStatisticsDataOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetIncomeStatisticsDataOutput>(null as any);
    }
    ...
    getEditionTenantStatistics(startDate: DateTime | undefined, endDate: DateTime | undefined): Promise<GetEditionTenantStatisticsOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetEditionTenantStatistics(_response);
        });
    }

    protected processGetEditionTenantStatistics(response: Response): Promise<GetEditionTenantStatisticsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetEditionTenantStatisticsOutput>(null as any);
    }
}
...
export class HostSettingsServiceProxy {
    ...
    protected processGetAllSettings(response: Response): Promise<HostSettingsEditDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processUpdateAllSettings(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getEnabledSocialLoginSettings(): Promise<ExternalLoginSettingsDto> {
    ...
    protected processGetEnabledSocialLoginSettings(response: Response): Promise<ExternalLoginSettingsDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class InstallServiceProxy {
     ...
     * @return Success
     */
    setup(body: InstallDto | undefined): Promise<void> {
    ...
    protected processSetup(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getAppSettingsJson(): Promise<AppSettingsJsonDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetAppSettingsJson(_response);
        });
    }

    protected processGetAppSettingsJson(response: Response): Promise<AppSettingsJsonDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<AppSettingsJsonDto>(null as any);
    }

    /**
     * @return Success
     */
    checkDatabase(): Promise<CheckDatabaseOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCheckDatabase(_response);
        });
    }

    protected processCheckDatabase(response: Response): Promise<CheckDatabaseOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<CheckDatabaseOutput>(null as any);
    }
}
...
export class InvoiceServiceProxy {
     ...
     * @return Success
     */
    getInvoiceInfo(id: number | undefined): Promise<InvoiceDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetInvoiceInfo(_response);
        });
    }

    protected processGetInvoiceInfo(response: Response): Promise<InvoiceDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    createInvoice(body: CreateInvoiceDto | undefined): Promise<void> {
    ...
    protected processCreateInvoice(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class LanguageServiceProxy {
    ...
    protected processGetLanguages(response: Response): Promise<GetLanguagesOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetLanguageForEdit(response: Response): Promise<GetLanguageForEditOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processCreateOrUpdateLanguage(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processDeleteLanguage(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processSetDefaultLanguage(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getLanguageTexts(maxResultCount: number | undefined, skipCount: number | undefined, sorting: string | undefined, sourceName: string, baseLanguageName: string | undefined, targetLanguageName: string, targetValueFilter: string | undefined, filterText: string | undefined): Promise<PagedResultDtoOfLanguageTextListDto> {
    ...
    protected processGetLanguageTexts(response: Response): Promise<PagedResultDtoOfLanguageTextListDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processUpdateLanguageText(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class NotificationServiceProxy {
    ...
    protected processGetUserNotifications(response: Response): Promise<GetNotificationsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    setAllNotificationsAsRead(): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSetAllNotificationsAsRead(_response);
        });
    }

    protected processSetAllNotificationsAsRead(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    setNotificationAsRead(body: EntityDtoOfGuid | undefined): Promise<SetNotificationAsReadOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSetNotificationAsRead(_response);
        });
    }

    protected processSetNotificationAsRead(response: Response): Promise<SetNotificationAsReadOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<SetNotificationAsReadOutput>(null as any);
    }
    ...
    protected processGetNotificationSettings(response: Response): Promise<GetNotificationSettingsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processUpdateNotificationSettings(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    deleteAllUserNotifications(state: UserNotificationState | undefined, startDate: DateTime | undefined, endDate: DateTime | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDeleteAllUserNotifications(_response);
        });
    }

    protected processDeleteAllUserNotifications(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class OrganizationUnitServiceProxy {
    ...
    protected processGetOrganizationUnits(response: Response): Promise<ListResultDtoOfOrganizationUnitDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListResultDtoOfOrganizationUnitDto>(null as any);
    }
     ...
     * @return Success
     */
    getOrganizationUnitUsers(id: number | undefined, sorting: string | undefined, maxResultCount: number | undefined, skipCount: number | undefined): Promise<PagedResultDtoOfOrganizationUnitUserListDto> {
    ...
    protected processGetOrganizationUnitUsers(response: Response): Promise<PagedResultDtoOfOrganizationUnitUserListDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getOrganizationUnitRoles(id: number | undefined, sorting: string | undefined, maxResultCount: number | undefined, skipCount: number | undefined): Promise<PagedResultDtoOfOrganizationUnitRoleListDto> {
    ...
    protected processGetOrganizationUnitRoles(response: Response): Promise<PagedResultDtoOfOrganizationUnitRoleListDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processCreateOrganizationUnit(response: Response): Promise<OrganizationUnitDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processUpdateOrganizationUnit(response: Response): Promise<OrganizationUnitDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processMoveOrganizationUnit(response: Response): Promise<OrganizationUnitDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processDeleteOrganizationUnit(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processRemoveUserFromOrganizationUnit(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processRemoveRoleFromOrganizationUnit(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processAddUsersToOrganizationUnit(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processAddRolesToOrganizationUnit(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processFindRoles(response: Response): Promise<PagedResultDtoOfNameValueDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class PaymentServiceProxy {
     ...
     * @return Success
     */
    getPaymentInfo(upgradeEditionId: number | undefined): Promise<PaymentInfoDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetPaymentInfo(_response);
        });
    }

    protected processGetPaymentInfo(response: Response): Promise<PaymentInfoDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PaymentInfoDto>(null as any);
    }
     ...
     * @return Success
     */
    createPayment(body: CreatePaymentDto | undefined): Promise<number> {
    ...
    protected processCreatePayment(response: Response): Promise<number> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    cancelPayment(body: CancelPaymentDto | undefined): Promise<void> {
    ...
    protected processCancelPayment(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getPaymentHistory(sorting: string | undefined, maxResultCount: number | undefined, skipCount: number | undefined): Promise<PagedResultDtoOfSubscriptionPaymentListDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetPaymentHistory(_response);
        });
    }

    protected processGetPaymentHistory(response: Response): Promise<PagedResultDtoOfSubscriptionPaymentListDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagedResultDtoOfSubscriptionPaymentListDto>(null as any);
    }
     ...
     * @return Success
     */
    getActiveGateways(recurringPaymentsEnabled: boolean | undefined): Promise<PaymentGatewayModel[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetActiveGateways(_response);
        });
    }

    protected processGetActiveGateways(response: Response): Promise<PaymentGatewayModel[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PaymentGatewayModel[]>(null as any);
    }
     ...
     * @return Success
     */
    getPayment(paymentId: number | undefined): Promise<SubscriptionPaymentDto> {
    ...
    protected processGetPayment(response: Response): Promise<SubscriptionPaymentDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<SubscriptionPaymentDto>(null as any);
    }

    /**
     * @return Success
     */
    getLastCompletedPayment(): Promise<SubscriptionPaymentDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetLastCompletedPayment(_response);
        });
    }

    protected processGetLastCompletedPayment(response: Response): Promise<SubscriptionPaymentDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    buyNowSucceed(paymentId: number | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processBuyNowSucceed(_response);
        });
    }

    protected processBuyNowSucceed(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    newRegistrationSucceed(paymentId: number | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processNewRegistrationSucceed(_response);
        });
    }

    protected processNewRegistrationSucceed(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    upgradeSucceed(paymentId: number | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUpgradeSucceed(_response);
        });
    }

    protected processUpgradeSucceed(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    extendSucceed(paymentId: number | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processExtendSucceed(_response);
        });
    }

    protected processExtendSucceed(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    paymentFailed(paymentId: number | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processPaymentFailed(_response);
        });
    }

    protected processPaymentFailed(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    switchBetweenFreeEditions(upgradeEditionId: number | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSwitchBetweenFreeEditions(_response);
        });
    }

    protected processSwitchBetweenFreeEditions(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    upgradeSubscriptionCostsLessThenMinAmount(editionId: number | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUpgradeSubscriptionCostsLessThenMinAmount(_response);
        });
    }

    protected processUpgradeSubscriptionCostsLessThenMinAmount(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    hasAnyPayment(): Promise<boolean> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processHasAnyPayment(_response);
        });
    }

    protected processHasAnyPayment(response: Response): Promise<boolean> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class PayPalPaymentServiceProxy {
     ...
     * @return Success
     */
    confirmPayment(paymentId: number | undefined, paypalOrderId: string | undefined): Promise<void> {
    ...
    protected processConfirmPayment(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getConfiguration(): Promise<PayPalConfigurationDto> {
    ...
    protected processGetConfiguration(response: Response): Promise<PayPalConfigurationDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PayPalConfigurationDto>(null as any);
    }
}
...
export class PermissionServiceProxy {
    ...
    protected processGetAllPermissions(response: Response): Promise<ListResultDtoOfFlatPermissionWithLevelDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class ProfileServiceProxy {
    ...
    protected processGetCurrentUserProfileForEdit(response: Response): Promise<CurrentUserProfileEditDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    disableGoogleAuthenticator(): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDisableGoogleAuthenticator(_response);
        });
    }

    protected processDisableGoogleAuthenticator(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    updateGoogleAuthenticatorKey(): Promise<UpdateGoogleAuthenticatorKeyOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUpdateGoogleAuthenticatorKey(_response);
        });
    }

    protected processUpdateGoogleAuthenticatorKey(response: Response): Promise<UpdateGoogleAuthenticatorKeyOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<UpdateGoogleAuthenticatorKeyOutput>(null as any);
    }
     ...
     * @return Success
     */
    sendVerificationSms(body: SendVerificationSmsInputDto | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSendVerificationSms(_response);
        });
    }

    protected processSendVerificationSms(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    verifySmsCode(body: VerifySmsCodeInputDto | undefined): Promise<void> {
    ...
    protected processVerifySmsCode(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    prepareCollectedData(): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processPrepareCollectedData(_response);
        });
    }

    protected processPrepareCollectedData(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processUpdateCurrentUserProfile(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getPasswordComplexitySetting(): Promise<GetPasswordComplexitySettingOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetPasswordComplexitySetting(_response);
        });
    }

    protected processGetPasswordComplexitySetting(response: Response): Promise<GetPasswordComplexitySettingOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetPasswordComplexitySettingOutput>(null as any);
    }

    /**
     * @return Success
     */
    getProfilePicture(): Promise<GetProfilePictureOutput> {
    ...
    protected processGetProfilePicture(response: Response): Promise<GetProfilePictureOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetProfilePictureOutput>(null as any);
    }
     ...
     * @return Success
     */
    getProfilePictureByUserName(username: string | undefined): Promise<GetProfilePictureOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetProfilePictureByUserName(_response);
        });
    }

    protected processGetProfilePictureByUserName(response: Response): Promise<GetProfilePictureOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getFriendProfilePicture(userId: number | undefined, tenantId: number | undefined): Promise<GetProfilePictureOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetFriendProfilePicture(_response);
        });
    }

    protected processGetFriendProfilePicture(response: Response): Promise<GetProfilePictureOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getProfilePictureByUser(userId: number | undefined): Promise<GetProfilePictureOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetProfilePictureByUser(_response);
        });
    }

    protected processGetProfilePictureByUser(response: Response): Promise<GetProfilePictureOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class RoleServiceProxy {
     ...
     * @return Success
     */
    getRoles(body: GetRolesInput | undefined): Promise<ListResultDtoOfRoleListDto> {
     ...
     * @return Success
     */
    createOrUpdateRole(body: CreateOrUpdateRoleInput | undefined): Promise<void> {
    ...
    protected processCreateOrUpdateRole(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    deleteRole(id: number | undefined): Promise<void> {
...
export class SessionServiceProxy {
    ...
    protected processUpdateUserSignInToken(response: Response): Promise<UpdateUserSignInTokenOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class StripePaymentServiceProxy {
     ...
     * @return Success
     */
    getConfiguration(): Promise<StripeConfigurationDto> {
    ...
    protected processGetConfiguration(response: Response): Promise<StripeConfigurationDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<StripeConfigurationDto>(null as any);
    }
     ...
     * @return Success
     */
    getPayment(stripeSessionId: string | undefined): Promise<SubscriptionPaymentDto> {
     ...
     * @return Success
     */
    createPaymentSession(body: StripeCreatePaymentSessionInput | undefined): Promise<string> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCreatePaymentSession(_response);
        });
    }

    protected processCreatePaymentSession(response: Response): Promise<string> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getPaymentResult(paymentId: number | undefined): Promise<StripePaymentResultOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetPaymentResult(_response);
        });
    }

    protected processGetPaymentResult(response: Response): Promise<StripePaymentResultOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<StripePaymentResultOutput>(null as any);
    }
}
...
export class SubscriptionServiceProxy {
     ...
     * @return Success
     */
    disableRecurringPayments(): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDisableRecurringPayments(_response);
        });
    }

    protected processDisableRecurringPayments(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    enableRecurringPayments(): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processEnableRecurringPayments(_response);
        });
    }

    protected processEnableRecurringPayments(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class TenantServiceProxy {
    ...
    protected processGetTenants(response: Response): Promise<PagedResultDtoOfTenantListDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    createTenant(body: CreateTenantInput | undefined): Promise<void> {
    ...
    protected processCreateTenant(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getTenantForEdit(id: number | undefined): Promise<TenantEditDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetTenantForEdit(_response);
        });
    }

    protected processGetTenantForEdit(response: Response): Promise<TenantEditDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    updateTenant(body: TenantEditDto | undefined): Promise<void> {
     ...
     * @return Success
     */
    deleteTenant(id: number | undefined): Promise<void> {
    ...
    protected processGetTenantFeaturesForEdit(response: Response): Promise<GetTenantFeaturesEditOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processUpdateTenantFeatures(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processResetTenantSpecificFeatures(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processUnlockTenantAdmin(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class TenantCustomizationServiceProxy {
     ...
     * @return Success
     */
    getTenantLogo(skin: string, tenantId: number | undefined, extension: string | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetTenantLogo(_response);
        });
    }

    protected processGetTenantLogo(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class TenantDashboardServiceProxy {
     ...
     * @return Success
     */
    getMemberActivity(): Promise<GetMemberActivityOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetMemberActivity(_response);
        });
    }

    protected processGetMemberActivity(response: Response): Promise<GetMemberActivityOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetMemberActivityOutput>(null as any);
    }

    /**
     * @return Success
     */
    getDashboardData(salesSummaryDatePeriod: SalesSummaryDatePeriod): Promise<GetDashboardDataOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetDashboardData(_response);
        });
    }

    protected processGetDashboardData(response: Response): Promise<GetDashboardDataOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetDashboardDataOutput>(null as any);
    }

    /**
     * @return Success
     */
    getTopStats(): Promise<GetTopStatsOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetTopStats(_response);
        });
    }

    protected processGetTopStats(response: Response): Promise<GetTopStatsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetTopStatsOutput>(null as any);
    }

    /**
     * @return Success
     */
    getProfitShare(): Promise<GetProfitShareOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetProfitShare(_response);
        });
    }

    protected processGetProfitShare(response: Response): Promise<GetProfitShareOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetProfitShareOutput>(null as any);
    }

    /**
     * @return Success
     */
    getDailySales(): Promise<GetDailySalesOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetDailySales(_response);
        });
    }

    protected processGetDailySales(response: Response): Promise<GetDailySalesOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetDailySalesOutput>(null as any);
    }

    /**
     * @return Success
     */
    getSalesSummary(salesSummaryDatePeriod: SalesSummaryDatePeriod): Promise<GetSalesSummaryOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetSalesSummary(_response);
        });
    }

    protected processGetSalesSummary(response: Response): Promise<GetSalesSummaryOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetSalesSummaryOutput>(null as any);
    }

    /**
     * @return Success
     */
    getRegionalStats(): Promise<GetRegionalStatsOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetRegionalStats(_response);
        });
    }

    protected processGetRegionalStats(response: Response): Promise<GetRegionalStatsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetRegionalStatsOutput>(null as any);
    }

    /**
     * @return Success
     */
    getGeneralStats(): Promise<GetGeneralStatsOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetGeneralStats(_response);
        });
    }

    protected processGetGeneralStats(response: Response): Promise<GetGeneralStatsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<GetGeneralStatsOutput>(null as any);
    }
}
...
export class TenantRegistrationServiceProxy {
     ...
     * @return Success
     */
    registerTenant(body: RegisterTenantInput | undefined): Promise<RegisterTenantOutput> {
    ...
    protected processRegisterTenant(response: Response): Promise<RegisterTenantOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<RegisterTenantOutput>(null as any);
    }

    /**
     * @return Success
     */
    getEditionsForSelect(): Promise<EditionsSelectOutput> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetEditionsForSelect(_response);
        });
    }

    protected processGetEditionsForSelect(response: Response): Promise<EditionsSelectOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<EditionsSelectOutput>(null as any);
    }
     ...
     * @return Success
     */
    getEdition(editionId: number | undefined): Promise<EditionSelectDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetEdition(_response);
        });
    }

    protected processGetEdition(response: Response): Promise<EditionSelectDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<EditionSelectDto>(null as any);
    }
}
...
export class TenantSettingsServiceProxy {
    ...
    protected processGetAllSettings(response: Response): Promise<TenantSettingsEditDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processClearLogo(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processClearCustomCss(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class TimingServiceProxy {
    ...
    protected processGetTimezones(response: Response): Promise<ListResultDtoOfNameValueDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetTimezoneComboboxItems(response: Response): Promise<ComboboxItemDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class TokenAuthServiceProxy {
     ...
     * @return Success
     */
    refreshToken(refreshToken: string | undefined): Promise<RefreshTokenResult> {
    ...
    protected processRefreshToken(response: Response): Promise<RefreshTokenResult> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    sendTwoFactorAuthCode(body: SendTwoFactorAuthCodeModel | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSendTwoFactorAuthCode(_response);
        });
    }

    protected processSendTwoFactorAuthCode(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processImpersonatedAuthenticate(response: Response): Promise<ImpersonatedAuthenticateResultModel> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    delegatedImpersonatedAuthenticate(userDelegationId: number | undefined, impersonationToken: string | undefined): Promise<ImpersonatedAuthenticateResultModel> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDelegatedImpersonatedAuthenticate(_response);
        });
    }

    protected processDelegatedImpersonatedAuthenticate(response: Response): Promise<ImpersonatedAuthenticateResultModel> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processLinkedAccountAuthenticate(response: Response): Promise<SwitchedAccountAuthenticateResultModel> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    testNotification(message: string | undefined, severity: string | undefined): Promise<void> {
    ...
    protected processTestNotification(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class TwitterServiceProxy {
     ...
     * @return Success
     */
    getRequestToken(): Promise<TwitterGetRequestTokenResponse> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetRequestToken(_response);
        });
    }

    protected processGetRequestToken(response: Response): Promise<TwitterGetRequestTokenResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<TwitterGetRequestTokenResponse>(null as any);
    }
     ...
     * @return Success
     */
    getAccessToken(token: string | undefined, verifier: string | undefined): Promise<TwitterGetAccessTokenResponse> {
    ...
    protected processGetAccessToken(response: Response): Promise<TwitterGetAccessTokenResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<TwitterGetAccessTokenResponse>(null as any);
    }
}
...
export class UiCustomizationSettingsServiceProxy {
     ...
     * @return Success
     */
    getUiManagementSettings(): Promise<ThemeSettingsDto[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetUiManagementSettings(_response);
        });
    }

    protected processGetUiManagementSettings(response: Response): Promise<ThemeSettingsDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ThemeSettingsDto[]>(null as any);
    }
     ...
     * @return Success
     */
    changeThemeWithDefaultValues(themeName: string | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processChangeThemeWithDefaultValues(_response);
        });
    }

    protected processChangeThemeWithDefaultValues(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    updateUiManagementSettings(body: ThemeSettingsDto | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUpdateUiManagementSettings(_response);
        });
    }

    protected processUpdateUiManagementSettings(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    updateDefaultUiManagementSettings(body: ThemeSettingsDto | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUpdateDefaultUiManagementSettings(_response);
        });
    }

    protected processUpdateDefaultUiManagementSettings(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    useSystemDefaultSettings(): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUseSystemDefaultSettings(_response);
        });
    }

    protected processUseSystemDefaultSettings(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class UserServiceProxy {
     ...
     * @return Success
     */
    getUsers(body: GetUsersInput | undefined): Promise<PagedResultDtoOfUserListDto> {
    ...
    protected processGetUsers(response: Response): Promise<PagedResultDtoOfUserListDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getUsersToExcel(filter: string | undefined, permissions: string[] | undefined, role: number | undefined, onlyLockedUsers: boolean | undefined, sorting: string | undefined): Promise<FileDto> {
    ...
    protected processGetUsersToExcel(response: Response): Promise<FileDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetUserForEdit(response: Response): Promise<GetUserForEditOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetUserPermissionsForEdit(response: Response): Promise<GetUserPermissionsForEditOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    resetUserSpecificPermissions(body: EntityDtoOfInt64 | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processResetUserSpecificPermissions(_response);
        });
    }

    protected processResetUserSpecificPermissions(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    updateUserPermissions(body: UpdateUserPermissionsInput | undefined): Promise<void> {
    ...
    protected processUpdateUserPermissions(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    unlockUser(body: EntityDtoOfInt64 | undefined): Promise<void> {
    ...
    protected processUnlockUser(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class UserDelegationServiceProxy {
     ...
     * @return Success
     */
    getDelegatedUsers(maxResultCount: number | undefined, skipCount: number | undefined, sorting: string | undefined): Promise<PagedResultDtoOfUserDelegationDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetDelegatedUsers(_response);
        });
    }

    protected processGetDelegatedUsers(response: Response): Promise<PagedResultDtoOfUserDelegationDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagedResultDtoOfUserDelegationDto>(null as any);
    }
     ...
     * @return Success
     */
    delegateNewUser(body: CreateUserDelegationDto | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDelegateNewUser(_response);
        });
    }

    protected processDelegateNewUser(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    removeDelegation(id: number | undefined): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processRemoveDelegation(_response);
        });
    }

    protected processRemoveDelegation(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getActiveUserDelegations(): Promise<UserDelegationDto[]> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetActiveUserDelegations(_response);
        });
    }

    protected processGetActiveUserDelegations(response: Response): Promise<UserDelegationDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<UserDelegationDto[]>(null as any);
    }
}
...
export class UserLinkServiceProxy {
    ...
    protected processLinkToUser(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetLinkedUsers(response: Response): Promise<PagedResultDtoOfLinkedUserDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processGetRecentlyUsedLinkedUsers(response: Response): Promise<ListResultDtoOfLinkedUserDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processUnlinkUser(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class UserLoginServiceProxy {
    ...
    getUserLoginAttempts(filter: string | undefined, startDate: DateTime | undefined, endDate: DateTime | undefined, result: AbpLoginResultType | undefined, sorting: string | undefined, maxResultCount: number | undefined, skipCount: number | undefined): Promise<PagedResultDtoOfUserLoginAttemptDto> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetUserLoginAttempts(_response);
        });
    }

    protected processGetUserLoginAttempts(response: Response): Promise<PagedResultDtoOfUserLoginAttemptDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagedResultDtoOfUserLoginAttemptDto>(null as any);
    }
}
...
export class WebhookEventServiceProxy {
     ...
     * @return Success
     */
    get(id: string | undefined): Promise<WebhookEvent> {
    ...
    protected processGet(response: Response): Promise<WebhookEvent> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class WebhookSendAttemptServiceProxy {
     ...
     * @return Success
     */
    getAllSendAttempts(subscriptionId: string | undefined, maxResultCount: number | undefined, skipCount: number | undefined): Promise<PagedResultDtoOfGetAllSendAttemptsOutput> {
    ...
    protected processGetAllSendAttempts(response: Response): Promise<PagedResultDtoOfGetAllSendAttemptsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<PagedResultDtoOfGetAllSendAttemptsOutput>(null as any);
    }
     ...
     * @return Success
     */
    getAllSendAttemptsOfWebhookEvent(id: string | undefined): Promise<ListResultDtoOfGetAllSendAttemptsOfWebhookEventOutput> {
    ...
    protected processGetAllSendAttemptsOfWebhookEvent(response: Response): Promise<ListResultDtoOfGetAllSendAttemptsOfWebhookEventOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListResultDtoOfGetAllSendAttemptsOfWebhookEventOutput>(null as any);
    }
     ...
     * @return Success
     */
    resend(sendAttemptId: string | undefined): Promise<void> {
...
export class WebhookSubscriptionServiceProxy {
     ...
     * @return Success
     */
    publishTestWebhook(): Promise<string> {
    ...
    protected processPublishTestWebhook(response: Response): Promise<string> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getAllSubscriptions(): Promise<ListResultDtoOfGetAllSubscriptionsOutput> {
    ...
    protected processGetAllSubscriptions(response: Response): Promise<ListResultDtoOfGetAllSubscriptionsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListResultDtoOfGetAllSubscriptionsOutput>(null as any);
    }
     ...
     * @return Success
     */
    getSubscription(subscriptionId: string | undefined): Promise<WebhookSubscription> {
    ...
    protected processGetSubscription(response: Response): Promise<WebhookSubscription> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    addSubscription(body: WebhookSubscription | undefined): Promise<void> {
    ...
    protected processAddSubscription(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    updateSubscription(body: WebhookSubscription | undefined): Promise<void> {
     ...
     * @return Success
     */
    activateWebhookSubscription(body: ActivateWebhookSubscriptionInput | undefined): Promise<void> {
    ...
    protected processActivateWebhookSubscription(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    isSubscribed(webhookName: string | undefined): Promise<boolean> {
    ...
    protected processIsSubscribed(response: Response): Promise<boolean> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getAllSubscriptionsIfFeaturesGranted(webhookName: string | undefined): Promise<ListResultDtoOfGetAllSubscriptionsOutput> {
    ...
    protected processGetAllSubscriptionsIfFeaturesGranted(response: Response): Promise<ListResultDtoOfGetAllSubscriptionsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return Success
     */
    getAllAvailableWebhooks(): Promise<ListResultDtoOfGetAllAvailableWebhooksOutput> {
    ...
    protected processGetAllAvailableWebhooks(response: Response): Promise<ListResultDtoOfGetAllAvailableWebhooksOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ListResultDtoOfGetAllAvailableWebhooksOutput>(null as any);
    }
}
...
export class WebLogServiceProxy {
    ...
    protected processGetLatestWebLogs(response: Response): Promise<GetLatestWebLogsOutput> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processDownloadWebLogs(response: Response): Promise<FileDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
        ...
        if (data) {
            ...
            if (data.languages) {
                ...
                for (let i = 0; i < data.languages.length; i++) {
                    ...
                    this.languages[i] = item && !(<any>item).toJSON ? new NameValue(item) : <NameValue>item;
                }
            }
        }
    }
...
export interface IAppSettingsJsonDto {
    webSiteUrl?: string | undefined;
    serverSiteUrl?: string | undefined;
    languages?: INameValue[] | undefined;
}
...
export class CreateEditionDto implements ICreateEditionDto {
    ...
    constructor(data?: ICreateEditionDto) {
        if (data) {
            ...
            this.edition = data.edition && !(<any>data.edition).toJSON ? new EditionCreateDto(data.edition) : <EditionCreateDto>this.edition;
            if (data.featureValues) {
                this.featureValues = [];
                for (let i = 0; i < data.featureValues.length; i++) {
                    let item = data.featureValues[i];
                    this.featureValues[i] = item && !(<any>item).toJSON ? new NameValueDto(item) : <NameValueDto>item;
                }
            }
        }
        if (!data) {
...
export class CreateOrUpdateLanguageInput implements ICreateOrUpdateLanguageInput {
    ...
    constructor(data?: ICreateOrUpdateLanguageInput) {
        if (data) {
            ...
            this.language = data.language && !(<any>data.language).toJSON ? new ApplicationLanguageEditDto(data.language) : <ApplicationLanguageEditDto>this.language;
        }
        if (!data) {
...
export interface ICreateOrUpdateLanguageInput {
    language: IApplicationLanguageEditDto;
}
...
export class CreateOrUpdateRoleInput implements ICreateOrUpdateRoleInput {
    ...
    constructor(data?: ICreateOrUpdateRoleInput) {
        if (data) {
            ...
            this.role = data.role && !(<any>data.role).toJSON ? new RoleEditDto(data.role) : <RoleEditDto>this.role;
        }
        if (!data) {
...
export class CreateOrUpdateUserInput implements ICreateOrUpdateUserInput {
    ...
    constructor(data?: ICreateOrUpdateUserInput) {
        if (data) {
            ...
            this.user = data.user && !(<any>data.user).toJSON ? new UserEditDto(data.user) : <UserEditDto>this.user;
        }
        if (!data) {
        ...
        if (data) {
            ...
            if (data.pages) {
                ...
                for (let i = 0; i < data.pages.length; i++) {
                    ...
                    this.pages[i] = item && !(<any>item).toJSON ? new Page(item) : <Page>item;
                }
            }
        }
    }
        ...
        if (data) {
            ...
            if (data.widgets) {
                ...
                for (let i = 0; i < data.widgets.length; i++) {
                    let item = data.widgets[i];
                    this.widgets[i] = item && !(<any>item).toJSON ? new WidgetOutput(item) : <WidgetOutput>item;
                }
            }
        }
    }
...
export interface IDashboardOutput {
    name?: string | undefined;
    widgets?: IWidgetOutput[] | undefined;
}
...
export class EditionSelectDto implements IEditionSelectDto {
    ...
    constructor(data?: IEditionSelectDto) {
        if (data) {
            ...
            this.additionalData = data.additionalData && !(<any>data.additionalData).toJSON ? new AdditionalData(data.additionalData) : <AdditionalData>this.additionalData;
        }
    }
...
export class EditionsSelectOutput implements IEditionsSelectOutput {
    ...
    constructor(data?: IEditionsSelectOutput) {
        if (data) {
            ...
            if (data.allFeatures) {
                this.allFeatures = [];
                for (let i = 0; i < data.allFeatures.length; i++) {
                    let item = data.allFeatures[i];
                    this.allFeatures[i] = item && !(<any>item).toJSON ? new FlatFeatureSelectDto(item) : <FlatFeatureSelectDto>item;
                }
            }
            if (data.editionsWithFeatures) {
                this.editionsWithFeatures = [];
                for (let i = 0; i < data.editionsWithFeatures.length; i++) {
                    let item = data.editionsWithFeatures[i];
                    this.editionsWithFeatures[i] = item && !(<any>item).toJSON ? new EditionWithFeaturesDto(item) : <EditionWithFeaturesDto>item;
                }
            }
        }
    }
...
export interface IEditionsSelectOutput {
    allFeatures?: IFlatFeatureSelectDto[] | undefined;
    editionsWithFeatures?: IEditionWithFeaturesDto[] | undefined;
}
...
export class EditionWithFeaturesDto implements IEditionWithFeaturesDto {
    ...
    constructor(data?: IEditionWithFeaturesDto) {
        if (data) {
            ...
            this.edition = data.edition && !(<any>data.edition).toJSON ? new EditionSelectDto(data.edition) : <EditionSelectDto>this.edition;
            if (data.featureValues) {
                this.featureValues = [];
                for (let i = 0; i < data.featureValues.length; i++) {
                    let item = data.featureValues[i];
...
export class ExternalLoginProviderSettingsEditDto implements IExternalLoginProviderSettingsEditDto {
    ...
    constructor(data?: IExternalLoginProviderSettingsEditDto) {
        if (data) {
            ...
            this.facebook = data.facebook && !(<any>data.facebook).toJSON ? new FacebookExternalLoginProviderSettings(data.facebook) : <FacebookExternalLoginProviderSettings>this.facebook;
            this.google = data.google && !(<any>data.google).toJSON ? new GoogleExternalLoginProviderSettings(data.google) : <GoogleExternalLoginProviderSettings>this.google;
            this.twitter = data.twitter && !(<any>data.twitter).toJSON ? new TwitterExternalLoginProviderSettings(data.twitter) : <TwitterExternalLoginProviderSettings>this.twitter;
            this.microsoft = data.microsoft && !(<any>data.microsoft).toJSON ? new MicrosoftExternalLoginProviderSettings(data.microsoft) : <MicrosoftExternalLoginProviderSettings>this.microsoft;
            this.openIdConnect = data.openIdConnect && !(<any>data.openIdConnect).toJSON ? new OpenIdConnectExternalLoginProviderSettings(data.openIdConnect) : <OpenIdConnectExternalLoginProviderSettings>this.openIdConnect;
            if (data.openIdConnectClaimsMapping) {
                this.openIdConnectClaimsMapping = [];
                for (let i = 0; i < data.openIdConnectClaimsMapping.length; i++) {
                    let item = data.openIdConnectClaimsMapping[i];
                    this.openIdConnectClaimsMapping[i] = item && !(<any>item).toJSON ? new JsonClaimMapDto(item) : <JsonClaimMapDto>item;
                }
            }
            this.wsFederation = data.wsFederation && !(<any>data.wsFederation).toJSON ? new WsFederationExternalLoginProviderSettings(data.wsFederation) : <WsFederationExternalLoginProviderSettings>this.wsFederation;
            if (data.wsFederationClaimsMapping) {
                this.wsFederationClaimsMapping = [];
                for (let i = 0; i < data.wsFederationClaimsMapping.length; i++) {
                    let item = data.wsFederationClaimsMapping[i];
                    this.wsFederationClaimsMapping[i] = item && !(<any>item).toJSON ? new JsonClaimMapDto(item) : <JsonClaimMapDto>item;
                }
            }
        }
    }
...
export interface IExternalLoginProviderSettingsEditDto {
    facebook_IsDeactivated?: boolean;
    facebook?: IFacebookExternalLoginProviderSettings;
    google_IsDeactivated?: boolean;
    google?: IGoogleExternalLoginProviderSettings;
    twitter_IsDeactivated?: boolean;
    twitter?: ITwitterExternalLoginProviderSettings;
    microsoft_IsDeactivated?: boolean;
    microsoft?: IMicrosoftExternalLoginProviderSettings;
    openIdConnect_IsDeactivated?: boolean;
    openIdConnect?: IOpenIdConnectExternalLoginProviderSettings;
    openIdConnectClaimsMapping?: IJsonClaimMapDto[] | undefined;
    wsFederation_IsDeactivated?: boolean;
    wsFederation?: IWsFederationExternalLoginProviderSettings;
    wsFederationClaimsMapping?: IJsonClaimMapDto[] | undefined;
}
...
export class FeatureInputTypeDto implements IFeatureInputTypeDto {
    ...
    constructor(data?: IFeatureInputTypeDto) {
        if (data) {
            ...
            this.validator = data.validator && !(<any>data.validator).toJSON ? new IValueValidator(data.validator) : <IValueValidator>this.validator;
            this.itemSource = data.itemSource && !(<any>data.itemSource).toJSON ? new LocalizableComboboxItemSourceDto(data.itemSource) : <LocalizableComboboxItemSourceDto>this.itemSource;
        }
    }
...
export interface IFeatureInputTypeDto {
    name?: string | undefined;
    attributes?: { [key: string]: any; } | undefined;
    validator?: IIValueValidator;
    itemSource?: ILocalizableComboboxItemSourceDto;
}
...
export class FlatFeatureDto implements IFlatFeatureDto {
    ...
    constructor(data?: IFlatFeatureDto) {
        if (data) {
            ...
            this.inputType = data.inputType && !(<any>data.inputType).toJSON ? new FeatureInputTypeDto(data.inputType) : <FeatureInputTypeDto>this.inputType;
        }
    }
...
export interface IFlatFeatureDto {
    ...
    description?: string | undefined;
    defaultValue?: string | undefined;
    inputType?: IFeatureInputTypeDto;
}
...
export class FlatFeatureSelectDto implements IFlatFeatureSelectDto {
    ...
    constructor(data?: IFlatFeatureSelectDto) {
        if (data) {
            ...
            this.inputType = data.inputType && !(<any>data.inputType).toJSON ? new IInputType(data.inputType) : <IInputType>this.inputType;
        }
    }
        ...
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    ...
                    this.items[i] = item && !(<any>item).toJSON ? new GetAllDynamicEntityPropertyValuesOutputItem(item) : <GetAllDynamicEntityPropertyValuesOutputItem>item;
                }
            }
        }
    }
...
export interface IGetAllDynamicEntityPropertyValuesOutput {
    items?: IGetAllDynamicEntityPropertyValuesOutputItem[] | undefined;
}
...
export class GetCurrentLoginInformationsOutput implements IGetCurrentLoginInformationsOutput {
    ...
    constructor(data?: IGetCurrentLoginInformationsOutput) {
        if (data) {
            ...
            this.user = data.user && !(<any>data.user).toJSON ? new UserLoginInfoDto(data.user) : <UserLoginInfoDto>this.user;
            this.impersonatorUser = data.impersonatorUser && !(<any>data.impersonatorUser).toJSON ? new UserLoginInfoDto(data.impersonatorUser) : <UserLoginInfoDto>this.impersonatorUser;
            this.tenant = data.tenant && !(<any>data.tenant).toJSON ? new TenantLoginInfoDto(data.tenant) : <TenantLoginInfoDto>this.tenant;
            this.impersonatorTenant = data.impersonatorTenant && !(<any>data.impersonatorTenant).toJSON ? new TenantLoginInfoDto(data.impersonatorTenant) : <TenantLoginInfoDto>this.impersonatorTenant;
            this.application = data.application && !(<any>data.application).toJSON ? new ApplicationInfoDto(data.application) : <ApplicationInfoDto>this.application;
            this.theme = data.theme && !(<any>data.theme).toJSON ? new UiCustomizationSettingsDto(data.theme) : <UiCustomizationSettingsDto>this.theme;
        }
    }
...
export interface IGetCurrentLoginInformationsOutput {
    ...
    impersonatorUser?: IUserLoginInfoDto;
    tenant?: ITenantLoginInfoDto;
    impersonatorTenant?: ITenantLoginInfoDto;
    application?: IApplicationInfoDto;
    theme?: IUiCustomizationSettingsDto;
}
    ...
    constructor(data?: IGetDashboardDataOutput) {
        if (data) {
            ...
            if (data.salesSummary) {
                this.salesSummary = [];
                for (let i = 0; i < data.salesSummary.length; i++) {
                    let item = data.salesSummary[i];
                    this.salesSummary[i] = item && !(<any>item).toJSON ? new SalesSummaryData(item) : <SalesSummaryData>item;
                }
            }
        }
    }
...
export interface IGetDashboardDataOutput {
    ...
    newOrders?: number;
    newUsers?: number;
    salesSummary?: ISalesSummaryData[] | undefined;
    totalSales?: number;
    revenue?: number;
    expenses?: number;
    growth?: number;
...
export class GetEditionEditOutput implements IGetEditionEditOutput {
    ...
    constructor(data?: IGetEditionEditOutput) {
        if (data) {
            ...
            this.edition = data.edition && !(<any>data.edition).toJSON ? new EditionEditDto(data.edition) : <EditionEditDto>this.edition;
            if (data.featureValues) {
                this.featureValues = [];
                for (let i = 0; i < data.featureValues.length; i++) {
                    let item = data.featureValues[i];
            ...
            if (data.features) {
                ...
                for (let i = 0; i < data.features.length; i++) {
                    ...
                    this.features[i] = item && !(<any>item).toJSON ? new FlatFeatureDto(item) : <FlatFeatureDto>item;
                }
            }
        }
    }
...
export interface IGetEditionEditOutput {
    edition?: IEditionEditDto;
    featureValues?: INameValueDto[] | undefined;
    features?: IFlatFeatureDto[] | undefined;
}
...
export class GetEditionTenantStatisticsOutput implements IGetEditionTenantStatisticsOutput {
    ...
    constructor(data?: IGetEditionTenantStatisticsOutput) {
        if (data) {
            ...
            if (data.editionStatistics) {
                this.editionStatistics = [];
                for (let i = 0; i < data.editionStatistics.length; i++) {
                    let item = data.editionStatistics[i];
                    this.editionStatistics[i] = item && !(<any>item).toJSON ? new TenantEdition(item) : <TenantEdition>item;
                }
            }
        }
    }
...
export interface IGetEditionTenantStatisticsOutput {
    editionStatistics?: ITenantEdition[] | undefined;
}
...
export class GetExpiringTenantsOutput implements IGetExpiringTenantsOutput {
    ...
    constructor(data?: IGetExpiringTenantsOutput) {
        if (data) {
            ...
            if (data.expiringTenants) {
                this.expiringTenants = [];
                for (let i = 0; i < data.expiringTenants.length; i++) {
                    let item = data.expiringTenants[i];
                    this.expiringTenants[i] = item && !(<any>item).toJSON ? new ExpiringTenant(item) : <ExpiringTenant>item;
                }
            }
        }
    }
...
export class GetIncomeStatisticsDataOutput implements IGetIncomeStatisticsDataOutput {
    ...
    constructor(data?: IGetIncomeStatisticsDataOutput) {
        if (data) {
            ...
            if (data.incomeStatistics) {
                this.incomeStatistics = [];
                for (let i = 0; i < data.incomeStatistics.length; i++) {
                    let item = data.incomeStatistics[i];
                    this.incomeStatistics[i] = item && !(<any>item).toJSON ? new IncomeStastistic(item) : <IncomeStastistic>item;
                }
            }
        }
    }
...
export interface IGetIncomeStatisticsDataOutput {
    incomeStatistics?: IIncomeStastistic[] | undefined;
}
...
export class GetLanguageForEditOutput implements IGetLanguageForEditOutput {
    ...
    constructor(data?: IGetLanguageForEditOutput) {
        if (data) {
            ...
            this.language = data.language && !(<any>data.language).toJSON ? new ApplicationLanguageEditDto(data.language) : <ApplicationLanguageEditDto>this.language;
            if (data.languageNames) {
                this.languageNames = [];
                for (let i = 0; i < data.languageNames.length; i++) {
                    let item = data.languageNames[i];
                    this.languageNames[i] = item && !(<any>item).toJSON ? new ComboboxItemDto(item) : <ComboboxItemDto>item;
                }
            }
            if (data.flags) {
                this.flags = [];
                for (let i = 0; i < data.flags.length; i++) {
                    ...
                    this.flags[i] = item && !(<any>item).toJSON ? new ComboboxItemDto(item) : <ComboboxItemDto>item;
                }
            }
        }
    }
...
export interface IGetLanguageForEditOutput {
    language?: IApplicationLanguageEditDto;
    languageNames?: IComboboxItemDto[] | undefined;
    flags?: IComboboxItemDto[] | undefined;
}
    ...
    constructor(data?: IGetLanguagesOutput) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new ApplicationLanguageListDto(item) : <ApplicationLanguageListDto>item;
                }
            }
        }
    }
...
export interface IGetLanguagesOutput {
    defaultLanguageName?: string | undefined;
    items?: IApplicationLanguageListDto[] | undefined;
}
...
export class GetMemberActivityOutput implements IGetMemberActivityOutput {
    ...
    constructor(data?: IGetMemberActivityOutput) {
        if (data) {
            ...
            if (data.memberActivities) {
                this.memberActivities = [];
                for (let i = 0; i < data.memberActivities.length; i++) {
                    let item = data.memberActivities[i];
                    this.memberActivities[i] = item && !(<any>item).toJSON ? new MemberActivity(item) : <MemberActivity>item;
                }
            }
        }
    }
...
export interface IGetMemberActivityOutput {
    memberActivities?: IMemberActivity[] | undefined;
}
        ...
        if (data) {
            ...
            if (data.notifications) {
                ...
                for (let i = 0; i < data.notifications.length; i++) {
                    ...
                    this.notifications[i] = item && !(<any>item).toJSON ? new NotificationSubscriptionWithDisplayNameDto(item) : <NotificationSubscriptionWithDisplayNameDto>item;
                }
            }
        }
    }
...
export interface IGetNotificationSettingsOutput {
    receiveNotifications?: boolean;
    notifications?: INotificationSubscriptionWithDisplayNameDto[] | undefined;
}
    ...
    constructor(data?: IGetNotificationsOutput) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new UserNotification(item) : <UserNotification>item;
                }
            }
        }
    }
...
export interface IGetNotificationsOutput {
    unreadCount?: number;
    totalCount?: number;
    items?: IUserNotification[] | undefined;
}
...
export class GetPasswordComplexitySettingOutput implements IGetPasswordComplexitySettingOutput {
    ...
    constructor(data?: IGetPasswordComplexitySettingOutput) {
        if (data) {
            ...
            this.setting = data.setting && !(<any>data.setting).toJSON ? new PasswordComplexitySetting(data.setting) : <PasswordComplexitySetting>this.setting;
        }
    }
...
export interface IGetPasswordComplexitySettingOutput {
    setting?: IPasswordComplexitySetting;
}
...
export class GetRecentTenantsOutput implements IGetRecentTenantsOutput {
    ...
    constructor(data?: IGetRecentTenantsOutput) {
        if (data) {
            ...
            if (data.recentTenants) {
                this.recentTenants = [];
                for (let i = 0; i < data.recentTenants.length; i++) {
                    let item = data.recentTenants[i];
                    this.recentTenants[i] = item && !(<any>item).toJSON ? new RecentTenant(item) : <RecentTenant>item;
                }
            }
        }
    }
        ...
        if (data) {
            ...
            if (data.stats) {
                ...
                for (let i = 0; i < data.stats.length; i++) {
                    let item = data.stats[i];
                    this.stats[i] = item && !(<any>item).toJSON ? new RegionalStatCountry(item) : <RegionalStatCountry>item;
                }
            }
        }
    }
...
export interface IGetRegionalStatsOutput {
    stats?: IRegionalStatCountry[] | undefined;
}
        ...
        if (data) {
            ...
            if (data.permissions) {
                ...
                for (let i = 0; i < data.permissions.length; i++) {
                    ...
                    this.permissions[i] = item && !(<any>item).toJSON ? new FlatPermissionDto(item) : <FlatPermissionDto>item;
                }
            }
        }
    }
...
export interface IGetRoleForEditOutput {
    role?: IRoleEditDto;
    permissions?: IFlatPermissionDto[] | undefined;
    grantedPermissionNames?: string[] | undefined;
}
        ...
        if (data) {
            ...
            if (data.friends) {
                ...
                for (let i = 0; i < data.friends.length; i++) {
                    let item = data.friends[i];
                    this.friends[i] = item && !(<any>item).toJSON ? new FriendDto(item) : <FriendDto>item;
                }
            }
        }
    }
        ...
        if (data) {
            ...
            if (data.roles) {
                ...
                for (let i = 0; i < data.roles.length; i++) {
                    ...
                    this.roles[i] = item && !(<any>item).toJSON ? new UserRoleDto(item) : <UserRoleDto>item;
                }
            }
            if (data.allOrganizationUnits) {
                this.allOrganizationUnits = [];
                for (let i = 0; i < data.allOrganizationUnits.length; i++) {
                    let item = data.allOrganizationUnits[i];
                    this.allOrganizationUnits[i] = item && !(<any>item).toJSON ? new OrganizationUnitDto(item) : <OrganizationUnitDto>item;
                }
            }
        }
    }
...
export interface IGetUserForEditOutput {
    profilePictureId?: string | undefined;
    user?: IUserEditDto;
    roles?: IUserRoleDto[] | undefined;
    allOrganizationUnits?: IOrganizationUnitDto[] | undefined;
    memberedOrganizationUnits?: string[] | undefined;
}
...
export class HostSettingsEditDto implements IHostSettingsEditDto {
    ...
    constructor(data?: IHostSettingsEditDto) {
        if (data) {
            ...
            this.general = data.general && !(<any>data.general).toJSON ? new GeneralSettingsEditDto(data.general) : <GeneralSettingsEditDto>this.general;
            this.userManagement = data.userManagement && !(<any>data.userManagement).toJSON ? new HostUserManagementSettingsEditDto(data.userManagement) : <HostUserManagementSettingsEditDto>this.userManagement;
            this.email = data.email && !(<any>data.email).toJSON ? new EmailSettingsEditDto(data.email) : <EmailSettingsEditDto>this.email;
            this.tenantManagement = data.tenantManagement && !(<any>data.tenantManagement).toJSON ? new TenantManagementSettingsEditDto(data.tenantManagement) : <TenantManagementSettingsEditDto>this.tenantManagement;
            this.security = data.security && !(<any>data.security).toJSON ? new SecuritySettingsEditDto(data.security) : <SecuritySettingsEditDto>this.security;
            this.billing = data.billing && !(<any>data.billing).toJSON ? new HostBillingSettingsEditDto(data.billing) : <HostBillingSettingsEditDto>this.billing;
            this.otherSettings = data.otherSettings && !(<any>data.otherSettings).toJSON ? new OtherSettingsEditDto(data.otherSettings) : <OtherSettingsEditDto>this.otherSettings;
            this.externalLoginProviderSettings = data.externalLoginProviderSettings && !(<any>data.externalLoginProviderSettings).toJSON ? new ExternalLoginProviderSettingsEditDto(data.externalLoginProviderSettings) : <ExternalLoginProviderSettingsEditDto>this.externalLoginProviderSettings;
        }
        if (!data) {
...
export interface IHostSettingsEditDto {
    general: IGeneralSettingsEditDto;
    userManagement: IHostUserManagementSettingsEditDto;
    email: IEmailSettingsEditDto;
    tenantManagement: ITenantManagementSettingsEditDto;
    security: ISecuritySettingsEditDto;
    billing?: IHostBillingSettingsEditDto;
    otherSettings?: IOtherSettingsEditDto;
    externalLoginProviderSettings?: IExternalLoginProviderSettingsEditDto;
}
...
export class HostUserManagementSettingsEditDto implements IHostUserManagementSettingsEditDto {
    ...
    constructor(data?: IHostUserManagementSettingsEditDto) {
        if (data) {
            ...
            this.sessionTimeOutSettings = data.sessionTimeOutSettings && !(<any>data.sessionTimeOutSettings).toJSON ? new SessionTimeOutSettingsEditDto(data.sessionTimeOutSettings) : <SessionTimeOutSettingsEditDto>this.sessionTimeOutSettings;
            this.userPasswordSettings = data.userPasswordSettings && !(<any>data.userPasswordSettings).toJSON ? new UserPasswordSettingsEditDto(data.userPasswordSettings) : <UserPasswordSettingsEditDto>this.userPasswordSettings;
        }
    }
...
export interface IHostUserManagementSettingsEditDto {
    ...
    useCaptchaOnLogin?: boolean;
    allowUsingGravatarProfilePicture?: boolean;
    sessionTimeOutSettings?: ISessionTimeOutSettingsEditDto;
    userPasswordSettings?: IUserPasswordSettingsEditDto;
}
    ...
    constructor(data?: IInsertOrUpdateAllValuesInput) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new InsertOrUpdateAllValuesInputItem(item) : <InsertOrUpdateAllValuesInputItem>item;
                }
            }
        }
    }
...
export interface IInsertOrUpdateAllValuesInput {
    items?: IInsertOrUpdateAllValuesInputItem[] | undefined;
}
...
export class InstallDto implements IInstallDto {
    ...
    constructor(data?: IInstallDto) {
        if (data) {
            ...
            this.smtpSettings = data.smtpSettings && !(<any>data.smtpSettings).toJSON ? new EmailSettingsEditDto(data.smtpSettings) : <EmailSettingsEditDto>this.smtpSettings;
            this.billInfo = data.billInfo && !(<any>data.billInfo).toJSON ? new HostBillingSettingsEditDto(data.billInfo) : <HostBillingSettingsEditDto>this.billInfo;
        }
    }
...
export interface IInstallDto {
    ...
    serverUrl?: string | undefined;
    defaultLanguage: string;
    smtpSettings?: IEmailSettingsEditDto;
    billInfo?: IHostBillingSettingsEditDto;
}
    ...
    constructor(data?: IListResultDtoOfCacheDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new CacheDto(item) : <CacheDto>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfChatMessageDto {
    items?: IChatMessageDto[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfDynamicEntityPropertyDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new DynamicEntityPropertyDto(item) : <DynamicEntityPropertyDto>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfDynamicEntityPropertyDto {
    items?: IDynamicEntityPropertyDto[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfDynamicEntityPropertyValueDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new DynamicEntityPropertyValueDto(item) : <DynamicEntityPropertyValueDto>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfDynamicEntityPropertyValueDto {
    items?: IDynamicEntityPropertyValueDto[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfDynamicPropertyDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new DynamicPropertyDto(item) : <DynamicPropertyDto>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfDynamicPropertyDto {
    items?: IDynamicPropertyDto[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfDynamicPropertyValueDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new DynamicPropertyValueDto(item) : <DynamicPropertyValueDto>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfDynamicPropertyValueDto {
    items?: IDynamicPropertyValueDto[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfEditionListDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new EditionListDto(item) : <EditionListDto>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfEditionListDto {
    items?: IEditionListDto[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfFlatPermissionWithLevelDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new FlatPermissionWithLevelDto(item) : <FlatPermissionWithLevelDto>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfFlatPermissionWithLevelDto {
    items?: IFlatPermissionWithLevelDto[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfGetAllAvailableWebhooksOutput) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new GetAllAvailableWebhooksOutput(item) : <GetAllAvailableWebhooksOutput>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfGetAllAvailableWebhooksOutput {
    items?: IGetAllAvailableWebhooksOutput[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfGetAllEntitiesHasDynamicPropertyOutput) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new GetAllEntitiesHasDynamicPropertyOutput(item) : <GetAllEntitiesHasDynamicPropertyOutput>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfGetAllEntitiesHasDynamicPropertyOutput {
    items?: IGetAllEntitiesHasDynamicPropertyOutput[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfGetAllSendAttemptsOfWebhookEventOutput) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new GetAllSendAttemptsOfWebhookEventOutput(item) : <GetAllSendAttemptsOfWebhookEventOutput>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfGetAllSendAttemptsOfWebhookEventOutput {
    items?: IGetAllSendAttemptsOfWebhookEventOutput[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfGetAllSubscriptionsOutput) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new GetAllSubscriptionsOutput(item) : <GetAllSubscriptionsOutput>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfGetAllSubscriptionsOutput {
    items?: IGetAllSubscriptionsOutput[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfLinkedUserDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new LinkedUserDto(item) : <LinkedUserDto>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfLinkedUserDto {
    items?: ILinkedUserDto[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfNameValueDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new NameValueDto(item) : <NameValueDto>item;
                }
            }
        }
    }
    ...
    constructor(data?: IListResultDtoOfOrganizationUnitDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new OrganizationUnitDto(item) : <OrganizationUnitDto>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfOrganizationUnitDto {
    items?: IOrganizationUnitDto[] | undefined;
}
    ...
    constructor(data?: IListResultDtoOfRoleListDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new RoleListDto(item) : <RoleListDto>item;
                }
            }
        }
    }
    ...
    constructor(data?: IListResultDtoOfSubscribableEditionComboboxItemDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new SubscribableEditionComboboxItemDto(item) : <SubscribableEditionComboboxItemDto>item;
                }
            }
        }
    }
...
export interface IListResultDtoOfSubscribableEditionComboboxItemDto {
    items?: ISubscribableEditionComboboxItemDto[] | undefined;
}
    ...
    constructor(data?: ILocalizableComboboxItemSourceDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new LocalizableComboboxItemDto(item) : <LocalizableComboboxItemDto>item;
                }
            }
        }
    }
...
export interface ILocalizableComboboxItemSourceDto {
    items?: ILocalizableComboboxItemDto[] | undefined;
}
    ...
    constructor(data?: IPage) {
        if (data) {
            ...
            if (data.widgets) {
                ...
                for (let i = 0; i < data.widgets.length; i++) {
                    let item = data.widgets[i];
                    this.widgets[i] = item && !(<any>item).toJSON ? new Widget(item) : <Widget>item;
                }
            }
        }
    }
    ...
    constructor(data?: IPagedResultDtoOfAuditLogListDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new AuditLogListDto(item) : <AuditLogListDto>item;
                }
            }
        }
    }
...
export interface IPagedResultDtoOfAuditLogListDto {
    totalCount?: number;
    items?: IAuditLogListDto[] | undefined;
}
    ...
    constructor(data?: IPagedResultDtoOfEntityChangeListDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new EntityChangeListDto(item) : <EntityChangeListDto>item;
                }
            }
        }
    }
...
export interface IPagedResultDtoOfEntityChangeListDto {
    totalCount?: number;
    items?: IEntityChangeListDto[] | undefined;
}
    ...
    constructor(data?: IPagedResultDtoOfGetAllSendAttemptsOutput) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new GetAllSendAttemptsOutput(item) : <GetAllSendAttemptsOutput>item;
                }
            }
        }
    }
...
export interface IPagedResultDtoOfGetAllSendAttemptsOutput {
    totalCount?: number;
    items?: IGetAllSendAttemptsOutput[] | undefined;
}
    ...
    constructor(data?: IPagedResultDtoOfLanguageTextListDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new LanguageTextListDto(item) : <LanguageTextListDto>item;
                }
            }
        }
    }
...
export interface IPagedResultDtoOfLanguageTextListDto {
    totalCount?: number;
    items?: ILanguageTextListDto[] | undefined;
}
    ...
    constructor(data?: IPagedResultDtoOfOrganizationUnitRoleListDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new OrganizationUnitRoleListDto(item) : <OrganizationUnitRoleListDto>item;
                }
            }
        }
    }
...
export interface IPagedResultDtoOfOrganizationUnitRoleListDto {
    totalCount?: number;
    items?: IOrganizationUnitRoleListDto[] | undefined;
}
    ...
    constructor(data?: IPagedResultDtoOfOrganizationUnitUserListDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new OrganizationUnitUserListDto(item) : <OrganizationUnitUserListDto>item;
                }
            }
        }
    }
...
export interface IPagedResultDtoOfOrganizationUnitUserListDto {
    totalCount?: number;
    items?: IOrganizationUnitUserListDto[] | undefined;
}
    ...
    constructor(data?: IPagedResultDtoOfSubscriptionPaymentListDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new SubscriptionPaymentListDto(item) : <SubscriptionPaymentListDto>item;
                }
            }
        }
    }
...
export interface IPagedResultDtoOfSubscriptionPaymentListDto {
    totalCount?: number;
    items?: ISubscriptionPaymentListDto[] | undefined;
}
    ...
    constructor(data?: IPagedResultDtoOfTenantListDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new TenantListDto(item) : <TenantListDto>item;
                }
            }
        }
    }
...
export interface IPagedResultDtoOfTenantListDto {
    totalCount?: number;
    items?: ITenantListDto[] | undefined;
}
    ...
    constructor(data?: IPagedResultDtoOfUserDelegationDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new UserDelegationDto(item) : <UserDelegationDto>item;
                }
            }
        }
    }
...
export interface IPagedResultDtoOfUserDelegationDto {
    totalCount?: number;
    items?: IUserDelegationDto[] | undefined;
}
    ...
    constructor(data?: IPagedResultDtoOfUserListDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new UserListDto(item) : <UserListDto>item;
                }
            }
        }
    }
    ...
    constructor(data?: IPagedResultDtoOfUserLoginAttemptDto) {
        if (data) {
            ...
            if (data.items) {
                ...
                for (let i = 0; i < data.items.length; i++) {
                    let item = data.items[i];
                    this.items[i] = item && !(<any>item).toJSON ? new UserLoginAttemptDto(item) : <UserLoginAttemptDto>item;
                }
            }
        }
    }
...
export interface IPagedResultDtoOfUserLoginAttemptDto {
    totalCount?: number;
    items?: IUserLoginAttemptDto[] | undefined;
}
...
export class SecuritySettingsEditDto implements ISecuritySettingsEditDto {
    ...
    constructor(data?: ISecuritySettingsEditDto) {
        if (data) {
            ...
            this.passwordComplexity = data.passwordComplexity && !(<any>data.passwordComplexity).toJSON ? new PasswordComplexitySetting(data.passwordComplexity) : <PasswordComplexitySetting>this.passwordComplexity;
            this.defaultPasswordComplexity = data.defaultPasswordComplexity && !(<any>data.defaultPasswordComplexity).toJSON ? new PasswordComplexitySetting(data.defaultPasswordComplexity) : <PasswordComplexitySetting>this.defaultPasswordComplexity;
            this.userLockOut = data.userLockOut && !(<any>data.userLockOut).toJSON ? new UserLockOutSettingsEditDto(data.userLockOut) : <UserLockOutSettingsEditDto>this.userLockOut;
            this.twoFactorLogin = data.twoFactorLogin && !(<any>data.twoFactorLogin).toJSON ? new TwoFactorLoginSettingsEditDto(data.twoFactorLogin) : <TwoFactorLoginSettingsEditDto>this.twoFactorLogin;
        }
    }
...
export interface ISecuritySettingsEditDto {
    ...
    defaultPasswordComplexity?: IPasswordComplexitySetting;
    userLockOut?: IUserLockOutSettingsEditDto;
    twoFactorLogin?: ITwoFactorLoginSettingsEditDto;
}
...
export class TenantLoginInfoDto implements ITenantLoginInfoDto {
    ...
    constructor(data?: ITenantLoginInfoDto) {
        if (data) {
            ...
            this.edition = data.edition && !(<any>data.edition).toJSON ? new EditionInfoDto(data.edition) : <EditionInfoDto>this.edition;
            if (data.featureValues) {
                this.featureValues = [];
                for (let i = 0; i < data.featureValues.length; i++) {
                    let item = data.featureValues[i];
...
export class TenantNotification implements ITenantNotification {
    ...
    constructor(data?: ITenantNotification) {
        if (data) {
            ...
            this.data = data.data && !(<any>data.data).toJSON ? new NotificationData(data.data) : <NotificationData>this.data;
        }
    }
...
export class TenantSettingsEditDto implements ITenantSettingsEditDto {
    ...
    constructor(data?: ITenantSettingsEditDto) {
        if (data) {
            ...
            this.general = data.general && !(<any>data.general).toJSON ? new GeneralSettingsEditDto(data.general) : <GeneralSettingsEditDto>this.general;
            this.userManagement = data.userManagement && !(<any>data.userManagement).toJSON ? new TenantUserManagementSettingsEditDto(data.userManagement) : <TenantUserManagementSettingsEditDto>this.userManagement;
            this.email = data.email && !(<any>data.email).toJSON ? new TenantEmailSettingsEditDto(data.email) : <TenantEmailSettingsEditDto>this.email;
            this.ldap = data.ldap && !(<any>data.ldap).toJSON ? new LdapSettingsEditDto(data.ldap) : <LdapSettingsEditDto>this.ldap;
            this.security = data.security && !(<any>data.security).toJSON ? new SecuritySettingsEditDto(data.security) : <SecuritySettingsEditDto>this.security;
            this.billing = data.billing && !(<any>data.billing).toJSON ? new TenantBillingSettingsEditDto(data.billing) : <TenantBillingSettingsEditDto>this.billing;
            this.otherSettings = data.otherSettings && !(<any>data.otherSettings).toJSON ? new TenantOtherSettingsEditDto(data.otherSettings) : <TenantOtherSettingsEditDto>this.otherSettings;
            this.externalLoginProviderSettings = data.externalLoginProviderSettings && !(<any>data.externalLoginProviderSettings).toJSON ? new ExternalLoginProviderSettingsEditDto(data.externalLoginProviderSettings) : <ExternalLoginProviderSettingsEditDto>this.externalLoginProviderSettings;
        }
        if (!data) {
...
export interface ITenantSettingsEditDto {
    general?: IGeneralSettingsEditDto;
    userManagement: ITenantUserManagementSettingsEditDto;
    email?: ITenantEmailSettingsEditDto;
    ldap?: ILdapSettingsEditDto;
    security: ISecuritySettingsEditDto;
    billing?: ITenantBillingSettingsEditDto;
    otherSettings?: ITenantOtherSettingsEditDto;
    externalLoginProviderSettings?: IExternalLoginProviderSettingsEditDto;
}
...
export class ThemeSettingsDto implements IThemeSettingsDto {
    ...
    constructor(data?: IThemeSettingsDto) {
        if (data) {
            ...
            this.layout = data.layout && !(<any>data.layout).toJSON ? new ThemeLayoutSettingsDto(data.layout) : <ThemeLayoutSettingsDto>this.layout;
            this.header = data.header && !(<any>data.header).toJSON ? new ThemeHeaderSettingsDto(data.header) : <ThemeHeaderSettingsDto>this.header;
            this.subHeader = data.subHeader && !(<any>data.subHeader).toJSON ? new ThemeSubHeaderSettingsDto(data.subHeader) : <ThemeSubHeaderSettingsDto>this.subHeader;
            this.menu = data.menu && !(<any>data.menu).toJSON ? new ThemeMenuSettingsDto(data.menu) : <ThemeMenuSettingsDto>this.menu;
            this.footer = data.footer && !(<any>data.footer).toJSON ? new ThemeFooterSettingsDto(data.footer) : <ThemeFooterSettingsDto>this.footer;
        }
    }
...
export interface IThemeSettingsDto {
    theme?: string | undefined;
    layout?: IThemeLayoutSettingsDto;
    header?: IThemeHeaderSettingsDto;
    subHeader?: IThemeSubHeaderSettingsDto;
    menu?: IThemeMenuSettingsDto;
    footer?: IThemeFooterSettingsDto;
}
...
export class UiCustomizationSettingsDto implements IUiCustomizationSettingsDto {
    ...
    constructor(data?: IUiCustomizationSettingsDto) {
        if (data) {
            ...
            this.baseSettings = data.baseSettings && !(<any>data.baseSettings).toJSON ? new ThemeSettingsDto(data.baseSettings) : <ThemeSettingsDto>this.baseSettings;
        }
    }
...
export interface IUiCustomizationSettingsDto {
    baseSettings?: IThemeSettingsDto;
    isLeftMenuUsed?: boolean;
    isTopMenuUsed?: boolean;
    isTabMenuUsed?: boolean;
    allowMenuScroll?: boolean;
    ...
    constructor(data?: IUpdateNotificationSettingsInput) {
        if (data) {
            ...
            if (data.notifications) {
                ...
                for (let i = 0; i < data.notifications.length; i++) {
                    let item = data.notifications[i];
                    this.notifications[i] = item && !(<any>item).toJSON ? new NotificationSubscriptionDto(item) : <NotificationSubscriptionDto>item;
                }
            }
        }
    }
...
export interface IUpdateNotificationSettingsInput {
    receiveNotifications?: boolean;
    notifications?: INotificationSubscriptionDto[] | undefined;
}
    ...
    constructor(data?: IUserListDto) {
        if (data) {
            ...
            if (data.roles) {
                ...
                for (let i = 0; i < data.roles.length; i++) {
                    let item = data.roles[i];
                    this.roles[i] = item && !(<any>item).toJSON ? new UserListRoleDto(item) : <UserListRoleDto>item;
                }
            }
        }
    }
...
export class UserNotification implements IUserNotification {
    ...
    constructor(data?: IUserNotification) {
        if (data) {
            ...
            this.notification = data.notification && !(<any>data.notification).toJSON ? new TenantNotification(data.notification) : <TenantNotification>this.notification;
        }
    }
...
export interface IUserNotification {
    ...
    userId?: number;
    state?: UserNotificationState;
    notification?: ITenantNotification;
    id?: string;
}
        ...
        if (data) {
            ...
            if (data.filters) {
                ...
                for (let i = 0; i < data.filters.length; i++) {
                    ...
                    this.filters[i] = item && !(<any>item).toJSON ? new WidgetFilterOutput(item) : <WidgetFilterOutput>item;
                }
            }
        }
    }
...
export interface IWidgetOutput {
    ...
    name?: string | undefined;
    description?: string | undefined;
    filters?: IWidgetFilterOutput[] | undefined;
}
