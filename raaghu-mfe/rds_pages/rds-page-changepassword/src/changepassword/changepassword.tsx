...
import { RdsCompChangeUserPassword, RdsCompForgotPassword } from "../../../rds-components";
import { useTranslation } from "react-i18next";
import { useAppDispatch } from "../../../../libs/state-management";
import { changePassword, getUsersByUsername } from "../../../../libs/state-management/user/user-slice";
...
const ChangePassword = (props: ChangePasswordProps) => {
	...
	useEffect(() => {
		...
		if (datahostEmail) {
			dispatch(getUsersByUsername(datahostEmail) as any);
		}
	}, [dispatch])
	...
	function getPasswordDataSubmit(data: any) {
		if (loginUser) {
			...
			dispatch(changePassword(_data) as any)
		}
