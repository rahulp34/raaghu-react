...
export {default as RdsCompOrganizationTree} from "./rds-comp-organization-tree/rds-comp-organization-tree";
...
export {default as RdsCompIdentityManagement}  from './rds-comp-identity-management-new/rds-comp-identity-management-new'
export {default as RdsCompThemeNew}  from './rds-comp-theme-new/rds-comp-theme-new'
...
export {default as RdsCompIdentiyResourceBasic} from './rds-comp-identiy-resource-basic/rds-comp-identiy-resource-basic'
...
export {default as RdsCompChangeUserPassword} from './rds-comp-change-user-password/rds-comp-change-user-password';
export { default as RdsCompCharts } from "./rds-comp-charts";
export { default as RdsCompRegister } from "./rds-comp-register/rds-comp-register";