...
const RdsCompAccount = (props: any) => {
  ...
  const [accountGeneralData, setAccountGeneralData] = useState<any>(props.accountGeneralSettings);
  
  const [twoFactorData, settwoFactorData] = useState(props.accountTwoFactorSettings);
  const [externalProvider, setExternalProvider] = useState(props.accountExternalProvider);
  const [accountCaptchData, setaccountCaptchaData] = useState(props.accountCaptchaSettings);
...
<div className="row mt-2">
      ...
      <div className="col-md-6 sm-p-0">
          <div className="form-group mb-4">
          <RdsInput
            value={externalProvider[2].secretProperties[0].value? externalProvider[2].secretProperties[0].value:""}
            name="displayName"
            label="Secret Key"
            placeholder=""
            required={true}
  ...
  function setRegistrationCapcha(value: boolean) {
    setaccountCaptchaData({ ...accountCaptchData, useCaptchaOnRegistration: value });
  }
  ...
  function setSelfRegistration(value:boolean){
    setAccountGeneralData({...accountGeneralData, isSelfRegistrationEnabled:value})
  }
  //Google
    ...
    <div>
      ...
      <div className="row pt-3">
        <div className="col-md-12 mb-1">
          <RdsCheckbox label="Google" checked={externalProvider[0].enabled} onChange={(e) => {
              setGoogle(e.target.checked);
            }}></RdsCheckbox>
        </div>
        {googleCheckbox}
        <div className="col-md-12 mb-1">
          <RdsCheckbox label="Microsoft" checked={externalProvider[1].enabled} 
          onChange={(e) => {
        ...
        {microsoftCheckBox}
        <div className="col-md-12 mb-1">
          <RdsCheckbox label="Twitter" checked={externalProvider[2].enabled}
          onChange={(e) => {
      ...
      <div className=" justify-content-end d-flex bottom-0 pt-0" >
            ...
            <RdsButton
              ...
              label="SAVE"
              type="submit"
              onClick={()=>{props.handleAccountSettings({accountCaptchData:accountCaptchData,externalProvider:externalProvider,accountGeneralData:accountGeneralData,twoFactorData:twoFactorData})}}
              isOutline={false}
              colorVariant="primary"
              size="small"
            ></RdsButton>
