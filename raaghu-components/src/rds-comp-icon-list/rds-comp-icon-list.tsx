    ...
    <div className="container-fluid p-0 m-0">
      <div className="row">
        ...
        {renderIconList.map((iconName, id) => (
          ...
          >
            <div className="card-body text-center icon-box w-100 d-flex justify-content-center align-items-center position-relative">
              <div>
                <RdsIcon
                  key={id}
                  name={iconName}
            ...
            <a className="fs-7 pe-auto pt-1 pb-2 text-center">
              {id == identity ? (
                <span className="text-success iconcopy"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 21.388 21.196">
                ...
                <span className="iconcopy cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 21 21">
